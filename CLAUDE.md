...
This command **requires** the project directory as an argument via `/Users/harry/1_listmgr`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/Users/harry/1_listmgr/prompts/app_spec.txt` and `/Users/harry/1_listmgr/prompts/initializer_prompt.md`

If `/Users/harry/1_listmgr` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/Users/harry/1_listmgr/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/Users/harry/1_listmgr/prompts/app_spec.txt`
...
**Output path:** `/Users/harry/1_listmgr/prompts/initializer_prompt.md`
...
**Output path:** `/Users/harry/1_listmgr/prompts/.spec_status.json`
...
> "Your specification files have been created in `/Users/harry/1_listmgr/prompts/`!
>
> **Files created:**
> - `/Users/harry/1_listmgr/prompts/app_spec.txt`
> - `/Users/harry/1_listmgr/prompts/initializer_prompt.md`
>
